...
closeMobileMenu.addEventListener("keypress", ()=>{
    mobileMenu.classList.toggle("active");
});
...
function createCartElement() {
    ...
    cartItem.innerHTML = `
        <div class="cart-item-wrapper">
            ...
            <div class="cart-delete-product" tabindex="0" onclick="deleteCartElement()" onkeypress="deleteCartElement()">
...
cartMenuBtn.addEventListener("keypress", ()=> {
    cartMenu.classList.toggle("active");
})